<nav class="main-nav" aria-label="Main navigation">
    ...
    <div class="dropdown" role="menu" aria-hidden="true">
        <a href="https://bualkawan.siakkab.go.id/profil.html"><i class="fas fa-user"></i> Profil</a>
        <a href="https://bualkawan.siakkab.go.id/visi-misi.html"><i class="fas fa-bullseye"></i> Visi Misi</a>
    </div>
    </div>
