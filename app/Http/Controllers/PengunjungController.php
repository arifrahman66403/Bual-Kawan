...
class PengunjungController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('operator.pengunjung')->with('success', 'Data pengunjung berhasil diajukan!');
    }
    ...
    {
        $pengunjungs = \App\Models\KisPengunjung::orderBy('created_at', 'desc')->get();
